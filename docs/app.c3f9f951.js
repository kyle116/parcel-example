...
let newsKey = "214b0c558498448797163c59349a0165";
console.log(newsKey);
let newsSources = [`https://newsapi.org/v2/top-headlines?country=us&apiKey=${newsKey}`, 'https://www.reddit.com/top.json']; // API Call Examples
